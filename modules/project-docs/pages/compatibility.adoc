...
At time of writing (September 2024), this is 1.22 and 1.23.
...
To make development easier, the sdk_current_version} SDK includes the Capella client certificate ready installed.
...
[cols="7,6,6,6"]
|===
| | Server 7.0 & 7.1 | Server 7.2 | Server 7.6.x
