...
[source,go]
----
include::devguide:example$go/subdoc-lookupin.go[tag=lookupInGet, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-lookupin.go[tag=lookupInExists, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-lookupin.go[tag=lookupInMulti, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein.go[tag=mutateInUpsert, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein.go[tag=mutateInInsert, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein.go[tag=mutateInMulti, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays.go[tag=mutateInArrayAppend, indent=0]
----

.Array prepending a sub-document
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays.go[tag=mutateInArrayPrepend, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays.go[tag=mutateInArrayDoc, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays.go[tag=mutateInArrayDocMulti, indent=0]
----

.Add single array as element to existing array
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays.go[tag=mutateInArrayDocMultiSingle, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays.go[tag=mutateInArrayAppendMulti, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays.go[tag=mutateInArrayAppendCreatePath, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays.go[tag=mutateInArrayAddUnique, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays.go[tag=mutateInArrayInsert, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-counter.go[tag=mutateInIncrement, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-counter.go[tag=mutateInDecrement, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein.go[tag=mutateInCreatePath, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-lookupin.go[tag=lookupInAnyReplica, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-lookupin.go[tag=lookupInAllReplicas, indent=0]
----
...
[source,go]
----
include::example$subdoc.go[tag=concurrent, indent=0]
----
...
[source,go]
----
include::example$subdoc.go[tag=cas, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-durability.go[tag=traddurability, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-durability.go[tag=newdurability, indent=0]
----
...
This can be detected with `errors.Is(err, gocb.ErrPathNotFound)`.
...
This can be detected with `errors.Is(err, gocb.ErrPathExists)`.
...
This can be detected with `errors.Is(err, gocb.ErrPathMismatch)`.
