...
The complete code sample used on this page can be downloaded from https://github.com/couchbase/docs-sdk-go/blob/temp/2.9/modules/devguide/examples/go/kv-crud.go[here]
...
[source,go]
----
include::devguide:example$go/kv-range-scan.go[tag=range_scan_all_documents, indent=0]
----
...
[source,go]
----
include::devguide:example$go/kv-range-scan.go[tag=range_scan_prefix, indent=0]
----
...
[source,go]
----
include::devguide:example$go/kv-range-scan.go[tag=range_scan_sample, indent=0]
----
...
[source,go]
----
include::devguide:example$go/kv-range-scan.go[tag=range_scan_all_document_ids, indent=0]
----
